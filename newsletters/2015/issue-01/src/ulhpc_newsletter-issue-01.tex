...
% Time-stamp: <Fri 2016-01-29 18:57 svarrette>
...
\def\NewsletterURL{http://hpc.uni.lu/newsletters/ulhpc_newsletter-issue-01.pdf}
...
\input{_gpfs.md}
\clearpage
\input{_lcsb_storage.md}
\input{_new_hardware.md}
\input{_galaxy.md}
\newpage
%=======================================================
\section{\faCogs\  RESIF: Software / Modules Management}
\input{_RESIF.md}
