...
% Time-stamp: <Wed 2016-02-10 16:07 svarrette>
% 
...
\begin{tabular}{|l|c|c||lr|c|c|c|c|}
  % \cline{4-8}
  % \multicolumn{3}{c|}{} & \multicolumn{2}{|c|}{\textbf{Per Node Statistics}} & \multicolumn{3}{|c|}{\textbf{TOTAL}}\\
  \hline
  \rowcolor{lightgray}
  ...
  \multirow{9}{*}{\begin{sideways}\textbf{gaia}\end{sideways}}
  ...
  \hline
  %___________________________ Nyx/Viridis __________________________
  ...
  \cline{6-8}
  \multicolumn{8}{l}{OpenStack IaaS cluster:}\\
  \hline
   %___________________________ Pyro ??? __________________________
  \multirow{3}{*}{\begin{sideways}~~\textbf{pyro}\end{sideways}}
  ...
  \multicolumn{5}{r|}{\textbf{\texttt{pyro} TOTAL:}} & \cellcolor{lightgray} \textbf{\ulhpcPyroNodes} & \cellcolor{lightgray} \textbf{\ulhpcPyroCores} & \cellcolor{lightgray} \textbf{\ulhpcPyroTFlops\ TFlops} \\\cline{6-8}
