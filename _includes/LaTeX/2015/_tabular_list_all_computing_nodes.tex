...
\begin{tabular}{|l|c|c||lr|c|c|c|c|}
  ...
  \multicolumn{5}{r|}{\textbf{\texttt{pyro-openstack} TOTAL:}} & \cellcolor{lightgray} \textbf{\ulhpcPyroNodes} & \cellcolor{lightgray} \textbf{\ulhpcPyroCores} & \cellcolor{lightgray} \textbf{\ulhpcPyroTFlops\ TFlops} \\\cline{6-8}
