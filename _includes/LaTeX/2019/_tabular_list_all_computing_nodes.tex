...
\begin{tabular}{|l|c|c||lr|c|c|c|c|}
  ...
  \multirow{5}{*}{\textbf{iris}}
                          ...
                          & 2018 & Dell & Intel Xeon Gold 6132 @ 2.6 GHz      & $2\times14$C,768GB  & 18  & 504    & 41,93  TFlops   \\%\cline{4-5}
                          &      &      & \multicolumn{2}{r|}{\textit{Per node}: 4x NVIDIA Tesla V100 SXM2 32GB}           & 72 GPUs  & 368640 & 561,6 GPU TFlops \\\cline{2-8}
  ...
  \multicolumn{8}{c}{}\\
  \hline
  \multicolumn{8}{c}{\textbf{Decommissioned clusters (\alert{Planned MID-2019})}}\\
  \hline
  \multicolumn{8}{c}{}\\
  \hline
  \rowcolor{lightgray}
  ...
  \multirow{2}{4em}{\textbf{gaia}}
                          ...
                          &             &      & \multicolumn{2}{r|}{incl. \ulhpcGaiaNodes\ GPU nodes (2 to 4 NVidia Tesla per node)} & \ulhpcGaiaAccelerators\ GPUs & \ulhpcGaiaGPUCores & \cellcolor{lightgray} \textbf{+\ulhpcGaiaGPUTFlops\ GPU\ TFlops} \\
  \hline
