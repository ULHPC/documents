...
% Time-stamp: <Fri 2015-10-16 00:33 svarrette>
% 
...
\newcommand{\cmd}[1]{\begin{cmdline}\cmdlineentry{#1}\end{cmdline}}
...
%===================================================
\section{Introduction : Git around you}
\input{_intro.md}

%==========================================================
\section{About Version Control System (VCS)}
\input{_vcs.md}
...
%===================================================
\section{Collaborating / Working together}
\input{_git_server_setup.md}
\input{_remotes.md}
